...
void Delay::_execute(Entity* entity) {
    ...
    traceManager->trace(Util::TraceLevel::blockInternal,"Delay of: " + std::to_string(waitTime));
    ...
    traceManager->trace(Util::TraceLevel::blockInternal, "End of delay of entity " + std::to_string(entity->getEntityNumber()) + " scheduled to time " + std::to_string(delayEndTime));
}
